...
async function mainF(text) {
    ...
    if (text == "!help") {
        ...
        if (param == "pmpermit") {
            ...
            return `*link*\n\nIf you need a latest cricket scores , updates , news and many more with chatting with others about cricket in sri lanka. there you go.get the link & join with us for further cricket updates`
        } else {
            return commands
        }
    }
